...
function default_1(input) {
    ...
    var part2 = exports.part2(part1[1]);
    console.log("The elf with the most calories has ".concat(part1[0], " calories."));
    console.log("The top 3 elves can carry ".concat(part2, " calories."));
}
exports.default = default_1;
function part1(input) {
    var caloriesElves = [];
    var elve = 0;
    input.forEach(function (calorie) {
        if (calorie === "") {
    ...
    var caloriesElf = Math.max.apply(Math, caloriesElves);
