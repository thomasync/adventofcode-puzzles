...
function default_1(input) {
    ...
    console.log("".concat(part1, " pairs fully contain the other"));
    console.log("".concat(part2, " pairs overlap"));
}
...
function part2(input) {
    return input
        ...
        .reduce(function (acc, curr) {
        var inter = curr[0].filter(function (value) { return curr[1].includes(value); });
        if (inter.length > 0) {
            return acc + 1;
        }
        return acc;
